...
myLabel = Label(root, text="Respontas estarão aqui !")

myButton  = Button(root, text="Gerando Numero!", command=lis.geraNum,width = 25, height = 5,bg = 'orange',fg = 'blue',)
myButton1 = Button(root, text="Gerando 5 Numeros!", command=lis.gera5NumDisp,width = 15,bg = 'orange',fg = 'blue',)
myButton2 = Button(root, text="View 1!", command=lis.viewUm,width = 15,bg = 'orange',fg = 'blue',)
myButton3 = Button(root, text="View 2!", command=lis.viewDois,width = 15,bg = 'orange',fg = 'blue',)
myButton4 = Button(root, text="View 3!", command=lis.viewTres,width = 15,bg = 'orange',fg = 'blue',)

myButton5 = Button(root, text="Gerando Numero!", command=lis.geraNum,width = 15,bg = 'orange',fg = 'blue',)
myButton6 = Button(root, text="Gerando Numero!", command=lis.geraNum,width = 15,bg = 'orange',fg = 'blue',)
myButton7 = Button(root, text="Gerando Numero!", command=lis.geraNum,width = 15,bg = 'orange',fg = 'blue',)
myButton8 = Button(root, text="Gerando Numero!", command=lis.geraNum,width = 15,bg = 'orange',fg = 'blue',)
myButton9 = Button(root, text="Gerando Numero!", command=lis.geraNum,width = 15,bg = 'orange',fg = 'blue',)

myButton.config(font=("Courier", 10))
...
myButton.pack(pady=70,side=LEFT)
...
'''
myButton.grid(ipadx=10, ipady=10)
myButton1.grid(ipadx=10, ipady=10)
myButton2.grid(ipadx=10, ipady=10)
myButton3.grid(ipadx=10, ipady=10)
myButton4.grid(ipadx=10, ipady=10)

myButton5.grid(ipadx=10, ipady=10)
myButton6.grid(ipadx=10, ipady=10)
myButton7.grid(ipadx=10, ipady=10)
myButton8.grid(ipadx=10, ipady=10)
myButton9.grid(ipadx=10, ipady=10)
'''
